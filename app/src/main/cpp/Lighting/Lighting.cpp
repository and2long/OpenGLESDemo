//
// Created by Lilong Zhang on 2023/4/19.
//
#include <jni.h>
...
Java_com_example_openglesdemo_cver_NativeLibrary_stepLighting(JNIEnv *env, jclass clazz)
{
    lighting::renderFrame();
}
extern "C"
JNIEXPORT void JNICALL
Java_com_example_openglesdemo_cver_NativeLibrary_initLighting(JNIEnv *env, jclass clazz,
                                                              jint width,
                                                              jint height)
{
