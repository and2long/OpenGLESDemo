...
/* [indices] */
    GLushort indices[] = {0, 2, 3, 0, 1, 3, 4, 6, 7, 4, 5, 7, 8, 9, 10, 11, 8, 10, 12, 13, 14, 15,
                          12,
...
Java_com_example_openglesdemo_cver_NativeLibrary_stepSimpleCube(JNIEnv *env, jclass clazz)
{
    simpleCube::renderFrame();
}
extern "C"
JNIEXPORT void JNICALL
Java_com_example_openglesdemo_cver_NativeLibrary_initSimpleCube(JNIEnv *env, jclass clazz,
                                                                jint width,
                                                                jint height)
{
